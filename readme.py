...
with open('README.md', 'a') as readme_file:
    ...
    readme_file.write("| Service 1 | Service 2 | Service 3 | Service 4 | Service 5 | Service 6 | Service 7 | Service 8 |" + "\n")
    readme_file.write("| --- " * 8 + "|" "\n")
    
    for i in range(0, len(logo_files), 8):
        ...
        logos_in_row = [
            ...
            for logo_file in logo_files[i:i+8]
        ]
